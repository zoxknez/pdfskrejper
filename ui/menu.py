...
from config.sources import Source, SourceType, get_sources_by_type
...
class InteractiveMenu:
    ...
    def select_category(self) -> SourceType:
        ...
        choice = Prompt.ask("Vaš izbor", choices=["1", "2", "3", "4"], default="1")
    ...
    def select_source(self) -> Source:
        ...
        for idx, source in enumerate(sources, 1):
            table.add_row(str(idx), source.name, source.description)
    ...
    def get_search_query(self) -> str:
        ...
        use_search = Confirm.ask(
            "Da li želite da pretražujete specifične termine?", default=True
        )

        if use_search:
            self.search_query = Prompt.ask("Unesite pretragu (keywords)", default="")
        else:
            self.search_query = ""
    ...
    def get_max_results(self) -> int:
        ...
        max_input = Prompt.ask("Maksimalan broj rezultata", default="50")
    ...
    def get_custom_url(self) -> str:
        ...
        self.custom_url = Prompt.ask("Unesite URL za scraping", default="")
    ...
    def confirm_settings(self) -> bool:
        ...
        settings_table.add_row(
            "Kategorija:",
            self.selected_category.value if self.selected_category else "N/A",
        )
        settings_table.add_row(
            "Izvor:", self.selected_source.name if self.selected_source else "N/A"
        )
