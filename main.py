...
from config.sources import SourceType, get_source_by_name, Source
from scrapers import BooksScraper, ResearchScraper, MagazineScraper
...
def parse_arguments():
    ...
    parser.add_argument(
        '--source',
        type=str,
        help='Ime izvora (npr. "arxiv", "gutenberg")'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help='Maksimalan broj rezultata (default: 50)'
    )
    
    parser.add_argument(
        '--output',
        type=Path,
        help='Output direktorijum za preuzete fajlove'
    )
    
    parser.add_argument(
        '--url',
        type=str,
        help='Custom URL za scraping'
    )
    
    parser.add_argument(
        '--interactive',
        action='store_true',
        help='Pokreni interaktivni mod'
    )
